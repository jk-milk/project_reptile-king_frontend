...
function MypageOrderReviewCreate() {
  ...
  const handleSubmit = () => {
    const confirmSubmit = window.confirm('리뷰 작성을 완료하시겠습니까?');
    if (confirmSubmit) {
      window.location.href = '/mypage/order/review';
    }
  };
      ...
      <div className="pt-12 pb-24 mx-auto max-w-screen-xl flex">
        ...
        <div className="w-3/4 px-4">
          <div className="bg-gray-200 rounded px-5 py-4">
            <div className="font-bold text-2xl mb-3">리뷰작성</div>
            <div className="bg-white rounded px-5 py-4 pb-6">
              <div className="font-bold text-lg">이 상품에 대해서 얼마나 만족하시나요?</div>
...
export default MypageOrderReviewCreate;
