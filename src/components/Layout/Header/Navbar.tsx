          ...
          <nav>
            <ul className="md:flex items-center justify-between text-base text-black pt-4 md:pt-0">
              ...
              <ul className="md:flex items-center justify-between px-4">
                <li><Link to="/market" className="inline-block no-underline font-bold text-lg py-2 px-8 lg:-ml-2 hover:text-green-800 transition-colors duration-300 cursor-pointer">Market</Link></li>
                <li><Link to="/board" className="inline-block no-underline font-bold text-lg py-2 px-8 lg:-ml-2 hover:text-green-800 transition-colors duration-300 cursor-pointer">Community</Link></li>
                <li><Link to="/my-cage" className="inline-block no-underline font-bold text-lg py-2 px-8 lg:-ml-2 hover:text-green-800 transition-colors duration-300 cursor-pointer">MY CAGE</Link></li>
              </ul>
            </ul>
          </nav>
        </div>
          ...
          <div className="auth flex items-center w-full md:w-full">
            {isAuthenticated ? (
              ...
              <div className="relative flex items-center">
                ...
                {notificationDropdownOpen && <NotificationDropdown isOpen={notificationDropdownOpen} setIsOpen={setNotificationDropdownOpen} />}
              </div>
            ) : (
              // 로그인 하지 않은 상태
